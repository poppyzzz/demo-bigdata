...
sql="select * from (select rownum as ROWIDSTR,t.* from dzdz.dzdz_hwxx_zzsfp t where kpyf=${DATE}) where \$CONDITIONS"
...
bash ${UtilPath}/SqoopJdbc_Dzdz.sh ${dzdz_username} dzdz DZDZ_HWXX_ZZSFP "$sql" $map
