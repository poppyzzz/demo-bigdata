...
bash ${SqoopM2_dwhPath}/sqoop_m2_dwh_dj_nsrxx.sh $1 $2
bash ${SqoopM2_dwhPath}/sqoop_m2_dwh_dj_nsrxx_kz.sh $1 $2
# bash ${SqoopM2_dwhPath}/sqoop_m2_dwh_rd_nsrzg.sh $1 $2